...
export function ImportAgentsDialog({ open, onOpenChange, onImportComplete }: ImportAgentsDialogProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // Import agents
      const response = await adminApiClient.importAgents({
        source: source.trim(),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Import agents from a Git repository, external registry, or seed file
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input
              id="source"
              placeholder="https://github.com/user/repo or https://registry.example.com/v0/agents"
              value={source}
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="update" className="cursor-pointer">
              Update existing agents if they already exist
            </Label>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200 dark:bg-blue-950 dark:border-blue-800">
            ...
            <div className="text-sm text-blue-900 dark:text-blue-100">
              ...
              <ul className="mt-1 space-y-1 text-xs">
                ...
                <li>• Registry API: <code>https://registry.example.com/v0/agents</code></li>
                <li>• Direct JSON file: <code>https://example.com/agents.json</code></li>
              </ul>
            </div>
          </div>
        </div>
